...
import { Bell, CreditCard, Droplets, MapPin, Zap } from "lucide-react";
    ...
    <div className="space-y-6 animate-in fade-in zoom-in-95 duration-500">
      ...
      <div className="flex items-center justify-between">
         <div className="flex flex-col">
            ...
            <h1 className="text-2xl font-black text-primary">Ahmad Rifai</h1>
         </div>
         <div className="relative">
            ...
            {/* Notification Dot */}
            <div className="absolute top-0 right-0 w-3 h-3 bg-red-500 rounded-full border-2 border-white dark:border-slate-950"></div>
         </div>
      </div>
      ...
      <div>
         ...
         <div className="grid grid-cols-2 gap-4">
            <Card className="bg-white/50 dark:bg-slate-900/50 backdrop-blur-sm border-none shadow-sm h-full flex flex-col justify-center">
